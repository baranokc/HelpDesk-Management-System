...
export const lookupService = {
    ...
    getSubcategories: (categoryId: string) => getLookup ('lookups/categories/${categoryId}/subcategories'),
    ...
    getTeamMembers: async (teamId: string): Promise<TeamMemberLookupDto[]> => {const response = await api.get<TeamMemberLookupDto[]>('lookups/teams/${teamId}/members');
        return response.data;
    }
}