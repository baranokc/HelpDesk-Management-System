        ...
        >
          ...
          <div className="form-control w-full">
            ...
            <select
              ...
              className={`select select-bordered w-full bg-white dark:bg-slate-800 text-sm text-slate-900 dark:text-white border-slate-300 dark:border-slate-700 focus:select-primary ${
                validationErrors.departmentId
                  ? "select-error"
                  : ""
              }`}
