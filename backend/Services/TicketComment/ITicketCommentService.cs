...
public interface ITicketCommentService
{
    ...
    Task<TicketCommentDto?> AddCommentAsync(Guid ticketId, TicketCommentCreateDto dto, Guid userId, bool canManageAll, CancellationToken cancellationToken = default);    
