...
{
    Task<IReadOnlyCollection<TicketAttachmentDto>> GetAttachmentsAsync(Guid ticketId, Guid? commentId = null, CancellationToken cancellationToken = default);
    Task<TicketAttachmentDto?> GetAttachmentByIdAsync(Guid ticketId, Guid attachmentId, CancellationToken cancellationToken = default);
    Task<TicketAttachmentDownloadDto?> GetDownloadAsync(Guid ticketId, Guid attachmentId, CancellationToken cancellationToken = default);
