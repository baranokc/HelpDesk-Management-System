...
namespace backend.Migrations
{
    ...
    [Migration("20260810123102_DepartmentRemoval")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("backend.Entities.SatisfactionSurvey", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("backend.Entities.SlaCalendar", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("SlaCalendar", (string)null);
                });

            modelBuilder.Entity("backend.Entities.SlaHoliday", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("SlaHoliday", (string)null);
                });
            ...
            modelBuilder.Entity("backend.Entities.SlaRecord", b =>
                {
                    ...
                    b.Property<TimeSpan?>("RemainingFirstResponseTime")
                        .HasColumnType("interval");

                    b.Property<TimeSpan?>("RemainingResolutionTime")
                        .HasColumnType("interval");
            ...
            modelBuilder.Entity("backend.Entities.SlaWorkingPeriod", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("SlaCalendarId", "DayOfWeek", "StartTime", "EndTime")
                        .IsUnique();

                    b.ToTable("SlaWorkingPeriod", null, t =>
                        {
                            t.HasCheckConstraint("CK_SlaWorkingPeriod_StartBeforeEnd", "\"StartTime\" < \"EndTime\"");
                        });
                });
            ...
            modelBuilder.Entity("backend.Entities.TeamChatMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("TeamChatMessages", null, t =>
                        {
                            t.HasCheckConstraint("CK_TeamChatMessages_Audience", "(\"Audience\" = 0 AND \"TeamId\" IS NOT NULL) OR (\"Audience\" = 1 AND \"TeamId\" IS NULL)");
                        });
                });
            ...
            modelBuilder.Entity("backend.Entities.TeamMemberLeave", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TeamMemberId", "StartDate", "EndDate");

                    b.ToTable("TeamMemberLeave", null, t =>
                        {
                            t.HasCheckConstraint("CK_TeamMemberLeave_DateRange", "\"StartDate\" <= \"EndDate\"");
                        });
                });

            modelBuilder.Entity("backend.Entities.TeamMemberShift", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TeamMemberId", "DayOfWeek")
                        .IsUnique();

                    b.ToTable("TeamMemberShift", null, t =>
                        {
                            t.HasCheckConstraint("CK_TeamMemberShift_StartBeforeEnd", "\"StartTime\" < \"EndTime\"");
                        });
                });
            ...
            modelBuilder.Entity("backend.Entities.SlaHoliday", b =>
                {
                    b.HasOne("backend.Entities.SlaCalendar", "SlaCalendar")
                        .WithMany("Holidays")
            ...
            modelBuilder.Entity("backend.Entities.TeamMemberLeave", b =>
                {
                    ...
                    b.HasOne("backend.Entities.TeamMember", "TeamMember")
                        .WithMany("Leaves")
